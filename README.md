...
avatar is selected. Creator avatars collapse their channels until selected, and
selecting a creator shows the combined feed for that creator. The server-side
cache can still hold a larger set so reopening the app does not need to render
