...
export const translations = {
  en: {
    ...
    add: {
      open: "Add",
      aria: "Add channel or video",
      eyebrow: "Add",
      title: "Add to Youtarr",
      subtitle: "Paste a channel link or a one-off video link.",
      channelTitle: "Add channel",
    ...
    channels: {
      ...
      scrollLeft: "Scroll subscriptions left",
      scrollRight: "Scroll subscriptions right",
    ...
    floatplane: {
      ...
      allChannels: "All channels",
      channelsForCreator: "Creator channels",
      loadMore: "Load more",
    ...
    player: {
      ...
      playbackOverrideLabel: "Playback",
      playbackOverrideAuto: "Auto",
      playbackOverridePrimary: "Main",
      playbackOverrideAv1: "AV1",
      playbackOverrideVp9: "VP9",
    ...
    settings: {
      ...
      floatplaneSessionTitle: "Floatplane session token",
      floatplaneSessionBody:
        "Paste a fresh sails.sid here when Floatplane says the current session expired.",
      floatplaneSessionPlaceholder: "sails.sid=...",
      floatplaneSessionSave: "Save token",
      floatplaneSessionSaving: "Saving",
      floatplaneSessionSaved: "Floatplane session saved. Connection refreshed.",
      floatplaneSessionError: "Could not save Floatplane session token",
      floatplaneSessionTokenRequired: "Paste a Floatplane session token first.",
  ...
  nl: {
    ...
    add: {
      open: "Toevoegen",
      aria: "Kanaal of video toevoegen",
      eyebrow: "Toevoegen",
      title: "Toevoegen aan Youtarr",
      subtitle: "Plak een kanaallink of een losse videolink.",
      channelTitle: "Kanaal toevoegen",
    ...
    channels: {
      ...
      scrollLeft: "Abonnementen naar links scrollen",
      scrollRight: "Abonnementen naar rechts scrollen",
    ...
    floatplane: {
      ...
      allChannels: "Alle kanalen",
      channelsForCreator: "Creator-kanalen",
      loadMore: "Meer laden",
    ...
    player: {
      ...
      playbackOverrideLabel: "Afspeelroute",
      playbackOverrideAuto: "Auto",
      playbackOverridePrimary: "Hoofd",
      playbackOverrideAv1: "AV1",
      playbackOverrideVp9: "VP9",
    ...
    settings: {
      ...
      floatplaneSessionTitle: "Floatplane sessie-token",
      floatplaneSessionBody:
        "Plak hier een nieuwe sails.sid zodra Floatplane meldt dat de huidige sessie verlopen is.",
      floatplaneSessionPlaceholder: "sails.sid=...",
      floatplaneSessionSave: "Token opslaan",
      floatplaneSessionSaving: "Opslaan",
      floatplaneSessionSaved: "Floatplane sessie opgeslagen. Verbinding vernieuwd.",
      floatplaneSessionError: "Floatplane sessie-token opslaan mislukt",
      floatplaneSessionTokenRequired: "Plak eerst een Floatplane sessie-token.",
